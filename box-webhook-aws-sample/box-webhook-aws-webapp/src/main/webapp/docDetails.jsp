    ...
    <div class='row'>
      ...
      <div class='col-md-10' style="margin-left: -80px;">
        ...
        <c:if test="${supportsPreview}">
          ...
          <div class='row notifyLabel'>
            <div class='col-md-2'></div>
            <div class='col-md-10'>
              Notify me when previewed on this email:
            </div>
          </div>
          <div class='row'>
            <form action="notify-on-preview?fileId=${fileId}" method="post">
              <div class='col-md-2'></div>
              <div class='col-md-4'>
                <input class='notifyEmailInput' type='email' name='emailAddress'>
                </input>
              </div>
              <button class='btn btn-success btn-small' type='submit'>OK</button>
            </form>
          </div>
        </c:if>
      </div>
